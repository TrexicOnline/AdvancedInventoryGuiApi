package de.trexic.inventoryguiapi.internal.utilities;
...
public class SkullCreator {
     ...
     */
    public static ItemStack skullByName(String name) {
     ...
     * @return The head of the Player.
     */
    public static ItemStack skullByUUID(UUID id) {
     ...
     * @return The head of the Player.
     */
    public static ItemStack skullByUrl(String url) {
     ...
     * @return The head of the Player.
     */
    public static ItemStack skullByBase64(String base64) {
